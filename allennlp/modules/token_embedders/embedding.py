...
class Embedding(TokenEmbedder):
    ...
    def extend_vocab(self,
        ...
        pretrained_files_dict : Dict[str, str], (optional, default=None)
            Dict of pretrained_file_name to flattened_key defining location of
            Embedding params in the main level params. It is the same key used in
            ``files_to_archive`` in archival.py
        """
        ...
        pretrained_file = pretrained_file or pretrained_files_dict.get(self._pretrained_file, None)
